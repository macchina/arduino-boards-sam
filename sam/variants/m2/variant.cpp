...
// pPort,	ulPin,		ulPeripheralId, ulPinType, ulPinConfiguration,ulPinAttribute,	ulAnalogChannel,ulADCChannelNumber,ulPWMChannel,ulTCChannel
  ...
  { PIOC, PIO_PC22,			 ID_PIOC, PIO_PERIPH_B, PIO_DEFAULT, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM),   NO_ADC, NO_ADC, PWM_CH5,     NOT_ON_TIMER }, // GPIO6_EN/PWML5
  { PIOC, PIO_PC21,			 ID_PIOC, PIO_PERIPH_B, PIO_DEFAULT, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM),   NO_ADC, NO_ADC, PWM_CH4,     NOT_ON_TIMER }, // GPIO5_EN/PWML4
  // 10
  { PIOC, PIO_PC29B_TIOB7,   ID_PIOC, PIO_PERIPH_B, PIO_DEFAULT, (PIN_ATTR_DIGITAL|PIN_ATTR_TIMER), NO_ADC, NO_ADC, NOT_ON_PWM,  TC2_CHB7     }, // TIOB7
  { PIOD, PIO_PD7B_TIOA8,    ID_PIOD, PIO_PERIPH_B, PIO_DEFAULT, (PIN_ATTR_DIGITAL|PIN_ATTR_TIMER), NO_ADC, NO_ADC, NOT_ON_PWM,  TC2_CHA8     }, // TIOA8 - RGB RED
  { PIOD, PIO_PD8B_TIOB8,    ID_PIOD, PIO_PERIPH_B, PIO_DEFAULT, (PIN_ATTR_DIGITAL|PIN_ATTR_TIMER), NO_ADC, NO_ADC, NOT_ON_PWM,  TC2_CHB8     }, // TIOB8 - RGB Green
  ...
  { PIOD, PIO_PD10,          ID_PIOD, PIO_OUTPUT_0, PIO_DEFAULT, PIN_ATTR_DIGITAL,                  NO_ADC, NO_ADC, NOT_ON_PWM,  NOT_ON_TIMER }, // PIN 32 DS2 RED
  { PIOC, PIO_PC1,           ID_PIOC, PIO_OUTPUT_0, PIO_DEFAULT, PIN_ATTR_DIGITAL,                  NO_ADC, NO_ADC, NOT_ON_PWM,  NOT_ON_TIMER }, // PIN 33

  // 34
  { PIOC, PIO_PC2,           ID_PIOC, PIO_PERIPH_B, PIO_DEFAULT, (PIN_ATTR_DIGITAL | PIN_ATTR_PWM), NO_ADC, NO_ADC, PWM_CH0,	 NOT_ON_TIMER }, // GPIO1_EN/PWML0
  { PIOC, PIO_PC3,           ID_PIOC, PIO_PERIPH_B, PIO_DEFAULT, (PIN_ATTR_DIGITAL | PIN_ATTR_PWM),	NO_ADC, NO_ADC, PWM_CH0,	 NOT_ON_TIMER }, // GPIO1/PWMH0
  { PIOC, PIO_PC4,           ID_PIOC, PIO_PERIPH_B, PIO_DEFAULT, (PIN_ATTR_DIGITAL | PIN_ATTR_PWM), NO_ADC, NO_ADC, PWM_CH1,	 NOT_ON_TIMER }, // GPIO2_EN/PWML1
  { PIOC, PIO_PC5,           ID_PIOC, PIO_PERIPH_B, PIO_DEFAULT, (PIN_ATTR_DIGITAL | PIN_ATTR_PWM),	NO_ADC, NO_ADC, PWM_CH1,	 NOT_ON_TIMER }, // GPIO2/PWMH1

  // 38
  { PIOC, PIO_PC6,           ID_PIOC, PIO_PERIPH_B, PIO_DEFAULT, (PIN_ATTR_DIGITAL | PIN_ATTR_PWM),	NO_ADC, NO_ADC, PWM_CH2,	 NOT_ON_TIMER }, // GPIO3_EN/PWML2
  { PIOC, PIO_PC7,           ID_PIOC, PIO_PERIPH_B, PIO_DEFAULT, (PIN_ATTR_DIGITAL | PIN_ATTR_PWM),	NO_ADC, NO_ADC, PWM_CH2,	 NOT_ON_TIMER }, // GPIO3/PWMH2
  { PIOC, PIO_PC8,           ID_PIOC, PIO_PERIPH_B, PIO_DEFAULT, (PIN_ATTR_DIGITAL | PIN_ATTR_PWM),	NO_ADC, NO_ADC, PWM_CH3,	 NOT_ON_TIMER }, // GPIO4_EN/PWML3
  { PIOC, PIO_PC9,           ID_PIOC, PIO_PERIPH_B, PIO_DEFAULT, (PIN_ATTR_DIGITAL | PIN_ATTR_PWM),	NO_ADC, NO_ADC, PWM_CH3,	 NOT_ON_TIMER }, // GPIO4/PWMH3
  ...
  { PIOC, PIO_PC19,          ID_PIOC, PIO_PERIPH_B, PIO_DEFAULT, (PIN_ATTR_DIGITAL | PIN_ATTR_PWM),	NO_ADC, NO_ADC, PWM_CH5,	 NOT_ON_TIMER }, // GPIO6/PWMH5
  ...
  { PIOA, PIO_PA22,			 ID_PIOA, PIO_OUTPUT_0,	PIO_DEFAULT, PIN_ATTR_DIGITAL,					NO_ADC,	NO_ADC,	NOT_ON_PWM,  NOT_ON_TIMER }, // MCDA1
	// 58
  { PIOA, PIO_PA6,			 ID_PIOA, PIO_INPUT,    PIO_DEFAULT, PIN_ATTR_ANALOG,                   ADC4,   ADC3,   NOT_ON_PWM,  NOT_ON_TIMER }, // V_SENSE
  ...
  // 92 - 93 M2 Buttons X1 & PIN_EMAC_ERX1 **** Added TD 3/6/2017 ***
  ...
  // 95 GPIO5
  { PIOC, PIO_PC20,        ID_PIOC, PIO_PERIPH_B, PIO_DEFAULT, (PIN_ATTR_DIGITAL | PIN_ATTR_PWM),				 NO_ADC, NO_ADC, PWM_CH4,	 NOT_ON_TIMER },  // GPIO5/PWMH4
  // 96 AD15 CPU Chip Temperature
  { PIOD, PIO_PD5,		ID_PIOD, PIO_PERIPH_A, PIO_DEFAULT, PIN_ATTR_ANALOG,									 ADC15,	 ADC15, NOT_ON_PWM,  NOT_ON_TIMER }, // AD15 CPU Temperature
//{ PIOD, PIO_PD5,		ID_PIOD, PIO_NOT_A_PIN, PIO_DEFAULT, PIN_ATTR_ANALOG,									 ADC15,	 ADC15, NOT_ON_PWM,  NOT_ON_TIMER }, // AD15 CPU Temperature
	// 97 J1850_PWM_nVPW
  { PIOB, PIO_PB8A_EMDC,   ID_PIOB, PIO_PERIPH_A, PIO_DEFAULT, PIN_ATTR_DIGITAL,                  NO_ADC,  NO_ADC, NOT_ON_PWM,  NOT_ON_TIMER }, // J1850_PWM_nVPW
  // 98 5Volt Power Supply Buck Boost
  { PIOC, PIO_PC10,        ID_PIOC, PIO_OUTPUT_0, PIO_DEFAULT, PIN_ATTR_DIGITAL,                  NO_ADC, NO_ADC, NOT_ON_PWM,  NOT_ON_TIMER },  //BUCK_nDIS
  // 99 J1850_9141_ON
  { PIOB, PIO_PB5A_ERX0,   ID_PIOB, PIO_PERIPH_A, PIO_DEFAULT, PIN_ATTR_DIGITAL,                  NO_ADC,  NO_ADC, NOT_ON_PWM,  NOT_ON_TIMER }, // J1850_9141_ON
  // 100 XBE_RST
